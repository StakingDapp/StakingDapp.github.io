        ...
        <div className='container'>
            <div className='row box-row justify-content-between align-items-end mt-3'>
                <span className='col-md-6 col-sm-6 info-holder left'>
                    <p className='mb-2 top-text'>{tokenStaked / 100}% Broccolis Staked: </p>
                    <p className='top-text'>Owners that have staked:  </p>
                </span>
                <span className='col-md-6 col-sm-6 info-holder right'>
                    <p className='text-end mb-2 col-md-6 top-text ms-auto'>{tokenStaked} /10000</p>
            ...
            <div className='row justify-content-between'>
                <div className='col-md-6'>
                    ...
                    <div className='main-box'>
                        ...
                        <p className='balance-text'>{walletBalance} $BRCC</p>
                    </div>
                </div>
                <div className='col-md-6'>
                    <div className='main-box'>
            ...
            <div className='row box-row justify-content-between my-3'>
                <div className='col-md-6'>
                    <div className='main-box'>
                        <p className='box-text'>{tokenStakedByuser} staked Broccolis</p>
                        <p className='box-text'>Pending $BRCC Reward: {totalReward}</p>
                        <button className='box-btn my-3' onClick={() => {
                            withdraw()
                        }}>Claim</button>
                        <p className='box-text'>Daily Reward: {constantReward} $BRCC / BROCCOLI</p>
                        <p className='box-text'>You are currently earning: {rewardPerday} $BRCC / Day</p>
                    </div>
                </div>
                <div className='col-md-6'>
                    {
                        approveStatus === false ? (
                            <div className='main-box'>
                                <p className='box-text'>Step 1: Approve the contract to Enable Staking.</p>
                                <p className='box-text'>Step 2: Once complete, stake your Broccolis.</p>
